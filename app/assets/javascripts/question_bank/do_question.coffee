class DoQuestion
  ...
  write_wrong_information: (kind,wrong_msg)->
    ...
    if kind == 'multi_choice' || kind == 'mapping'

    if kind == 'multi_choice' || kind == 'mapping' || kind == 'mapping'
    ...
    $.ajax
      ...
      .success (msg) =>
        ...
        if information.length == 0
          ...
          @$elm.find('.do-question-msg p').text(wrong_information_mod)
    ...
    $.ajax
      ...
      .success (msg) =>
        ...
        if information.length == 0
          ...
          @$elm.find('.do-question-msg p').html(wrong_information_mod)
